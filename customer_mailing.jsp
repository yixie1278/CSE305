...
<head>
    <title>Customer-Representative Level Transaction - Customer mailing list</title>
    ...
    <span style="font-size: 14pt; font-family: Arial"><strong>Hello, Customer-Representative. Your Email is
        ...
        <%
          ...
          try{
            ...
            java.sql.ResultSet rs = stmt1.executeQuery("SELECT c.CustomerID, p.LastName, p.FirstName,p.Address FROM person p, customer c WHERE p.SSN=c.CustomerID");
